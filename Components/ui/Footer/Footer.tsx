            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-16 border-b border-white/5">
              ...
              Pizza Place Go
                    ...
                    <div className="flex items-center gap-4">
                        {/* Facebook */}
                        <a href="https://www.facebook.com/PizzaPlace.lk/" className="w-10 h-10 rounded-xl bg-neutral-800/50 hover:bg-amber-500 hover:text-neutral-950 flex items-center justify-center border border-white/5 hover:border-transparent transition-all duration-300 transform hover:scale-105">
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                                <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.8c4.56-.93 8-4.96 8-9.8z"/>
                            </svg>
                        </a>
                        {/* Instagram */}
                        <a href="https://www.instagram.com/popular/pizza-place-hingurakgoda-menu/" className="w-10 h-10 rounded-xl bg-neutral-800/50 hover:bg-amber-500 hover:text-neutral-950 flex items-center justify-center border border-white/5 hover:border-transparent transition-all duration-300 transform hover:scale-105">
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                        ...
                        {/* Linkedin/X */}
                        <a href="#" className="w-10 h-10 rounded-xl bg-neutral-800/50 hover:bg-[#0077b5] hover:text-white flex items-center justify-center border border-white/5 hover:border-transparent transition-all duration-300 transform hover:scale-105">
                            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
