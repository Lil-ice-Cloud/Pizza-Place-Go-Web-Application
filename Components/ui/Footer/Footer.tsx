            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-16 border-b border-white/5">
              ...
              Pizza Place Go
                    ...
                    <div className="flex items-center gap-4">
                        {/* Facebook */}
                        <a href="https://www.facebook.com/PizzaPlace.lk/" className="w-11 h-11 rounded-xl bg-neutral-800/50 hover:bg-amber-500 hover:text-neutral-950 flex items-center justify-center border border-white/5 hover:border-transparent transition-all duration-300 transform hover:scale-105">
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                                <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.8c4.56-.93 8-4.96 8-9.8z"/>
                            </svg>
                        </a>
                        {/* Instagram */}
                        <a href="https://www.instagram.com/popular/pizza-place-hingurakgoda-menu/" className="w-11 h-11 rounded-xl bg-neutral-800/50 hover:bg-amber-500 hover:text-neutral-950 flex items-center justify-center border border-white/5 hover:border-transparent transition-all duration-300 transform hover:scale-105">
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                        ...
                        {/* Twitter/X */}
                        <a href="#" className="w-11 h-11 rounded-xl bg-neutral-800/50 hover:bg-amber-500 hover:text-neutral-950 flex items-center justify-center border border-white/5 hover:border-transparent transition-all duration-300 transform hover:scale-105">
                            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                            </svg>
                        </a>
                        {/* Linkedin/X */}
                        <a href="#" className="w-11 h-11 rounded-xl bg-neutral-800/50 hover:bg-[#0077b5] hover:text-white flex items-center justify-center border border-white/5 hover:border-transparent transition-all duration-300 transform hover:scale-105">
                            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <ul className="flex flex-col gap-3 text-sm font-medium">
                        <li>
                            <Link href="/Meals_and_Pricing" className="hover:text-amber-500 transition-colors duration-300">
                                Meals & Pricing
                            </Link>
                        </li>
                        <li>
                            <Link href="/Locations" className="hover:text-amber-500 transition-colors duration-300">
                                Locations
                            </Link>
                        </li>
                        <li>
                    ...
                    <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl bg-neutral-950 border border-white/5 text-base sm:text-sm text-white focus:outline-none focus:border-amber-500/50 transition-all duration-300"
                            />
                        </div>
                        <button
                            type="submit"
                            disabled={subscribed}
                            className={`w-full min-h-11 py-3.5 rounded-xl font-bold text-xs uppercase tracking-wider transition-all duration-300 transform hover:scale-102 cursor-pointer ${
                                subscribed
             ...
             <a href="https://www.linkedin.com/in/mr-thanuja-marisha/" >
                 ...
                 ">
                     Mr.Thanuja
                        ...
                        <a href="https://www.linkedin.com/in/malindu-perera-4673911a5/">
                            <h1 className="
                            text-neutral-400
                            hover:text-amber-500
                            transition-colors
