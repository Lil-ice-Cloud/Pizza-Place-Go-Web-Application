...
export default function Home() {
    ...
    return (
        ...
        ">
            {/* Hero Section */}
            <main className="relative flex h-[100svh] min-h-[560px] w-full items-center justify-center overflow-hidden">
                {/* Background Video */}
                <Background/>
                {/* Hero Dark Overlay */}
                <div className="absolute inset-0 z-10 bg-black/60" />

                {/* Hero Content — centered by the flex on <main>, no absolute offsets */}
                <div className="relative z-20 mx-auto flex w-full max-w-4xl flex-col items-center px-5 pt-24 pb-12 text-center sm:px-6 sm:pt-28">
                    <span className="mb-5 animate-pulse rounded-full border border-white/20 bg-white/10 px-3.5 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-amber-400 backdrop-blur-md sm:mb-6 sm:px-4 sm:text-xs">
                        🍕 Blazing Fast Delivery
                    </span>
                    <h1 className="mb-4 font-heading text-4xl font-normal leading-[1.05] tracking-normal text-white sm:mb-6 sm:text-6xl md:text-8xl">
                        CRAVE THE HOTTEST<br />
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-amber-400 via-orange-500 to-red-500">
                            PIZZA DEALS
                        </span>
                    </h1>
                    <p className="mb-7 max-w-2xl text-sm font-light leading-relaxed text-neutral-300 sm:mb-10 sm:text-lg md:text-xl">
                    ...
                    <button
                        ...
                        className="group flex cursor-pointer items-center gap-3 rounded-full bg-linear-to-r from-amber-500 to-orange-600 px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-orange-500/30 transition-all duration-300 hover:scale-105 hover:from-amber-600 hover:to-orange-700 sm:px-8 sm:py-4 sm:text-base"
                    >
                        Explore Hot Deals
                        <svg
            ...
            <section id="hot-deals" className="relative w-full py-24 bg-neutral-950 text-white overflow-hidden border-t border-white/5">
                ...
                <div className="relative z-10 text-center max-w-2xl mx-auto mb-20 px-6">
                    ...
                    <h2 className="font-heading text-4xl sm:text-5xl md:text-6xl font-normal tracking-normal leading-[1.1] mb-4 text-white">
                        🔥 TODAY&apos;S HOT DEALS
                    </h2>
                            ...
                            <div className="flex flex-col grow p-6 lg:p-8">
                                ...
                                <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/5">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex min-h-11 items-center px-5 bg-neutral-800 hover:bg-linear-to-r hover:from-amber-500 hover:to-orange-600 hover:text-white text-neutral-200 text-xs font-bold rounded-xl transition-all duration-300 transform group-hover:scale-105 border border-white/5 hover:border-transparent cursor-pointer"
                                    >
                                        Claim Deal
                                    </button>
                                </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 justify-between items-center mb-12 pb-8 border-b border-white/5">
                        ...
                        <div className="relative w-full md:max-w-md">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-6 py-3.5 rounded-full bg-neutral-900/60 backdrop-blur-md border border-white/5 text-white focus:outline-none focus:border-amber-500/50 transition-all duration-300 text-base sm:text-sm placeholder-neutral-500 focus:ring-1 focus:ring-amber-500/20"
                            />
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2.5 justify-center">
                            {categories.map((category) => (
                                <button
                                    ...
                                    className={`inline-flex min-h-11 items-center px-5 rounded-full text-xs font-bold transition-all duration-300 cursor-pointer ${
                                    ...
                                    <div className="flex flex-col grow p-6">
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-white/5 mt-auto">
                                            ...
                                            <button
                                                ...
                                                className="inline-flex min-h-11 items-center px-4 bg-neutral-800 hover:bg-linear-to-r hover:from-amber-500 hover:to-orange-600 hover:text-white text-neutral-300 text-xs font-bold rounded-lg border border-white/5 hover:border-transparent transition-all duration-300 cursor-pointer"
                                            >
                                                Add to Cart
                                            </button>
                                        </div>
                    ...
                    <div className="relative bg-neutral-900/40 backdrop-blur-xl border border-white/5 rounded-3xl p-8 md:p-12 shadow-2xl">
                        ...
                        <div className="absolute inset-y-0 left-0 right-0 flex justify-between items-center px-4 pointer-events-none md:-mx-6">
                            <button
                                ...
                                className="w-11 h-11 rounded-full bg-neutral-900 border border-white/5 hover:border-amber-500/30 text-white flex items-center justify-center transition-all duration-300 hover:scale-105 pointer-events-auto cursor-pointer"
                            >
                                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
